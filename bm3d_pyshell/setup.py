"""BM3D Shell packaging and distribution."""
...
ext_modules = [Extension("bm3d_pyshell.shell",
                         language="c++",
                         sources=["bm3d_pyshell/shell.pyx",
                                  "bm3d/iio.c",
                                  "bm3d/bm3d.cpp",
                                  "bm3d/lib_transforms.cpp",
                                  "bm3d/utilities.cpp", ],
                         extra_compile_args=extra_compile_args,
                         libraries=libraries)]

# subprocess.check_output(['git', 'tag']).split()[-1][1:].decode("utf-8")
setup(name='bm3d_pyshell',
      version='0.1',
      description='BM3D shell to decompose by step by step.'
                  'This shell has the goal to communicate with an FPGA.',
      author='Rafael Pizarro Solar',
      author_email='rafael.pizarrosolar@epfl.ch',
      zip_safe=False,
      packages=['bm3d_pyshell'],
